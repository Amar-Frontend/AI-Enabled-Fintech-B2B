...
public class PojoClass {
	...
	{
		return "PojoClass [sl_no="+sl_no+",business_code="+business_code+",cust_number="+cust_number+",clear_date="+clear_date+",buisness_year="+buisness_year+",doc_id="+doc_id+",posting_date"+posting_date+",document_create_date"+document_create_date+
				",document_create_date1"+document_create_date1+",due_in_date"+due_in_date+",invoice_currency"+invoice_currency+",document_type"+document_type+
				...
				",isOpen"+isOpen+",aging_bucket"+aging_bucket+",is_deleted"+is_deleted+ "]";
	}
